...
public class Quickstart {
    ...
    private static final List<String> SCOPES =
            Arrays.asList(GmailScopes.GMAIL_MODIFY,GmailScopes.GMAIL_READONLY);
    ...
    /*public static void main(String[] args) throws IOException {
        ...
        /*try {
            Message mensaje = nueva.getFullMessage(service, user, "158da447fa359df6");
        }
        catch(MessagingException e){System.out.print("me cai");}
        control.main_menu();
    }*/
